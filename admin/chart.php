...
<!--                <canvas id="areaChart" style="height:250px"></canvas>-->
   ...
   <?php       
$select=$pdo->prepare("select product_name,sum(qty) as qt from tbl_invoice_details WHERE order_date BETWEEN :fromdate AND :todate group by product_id");
...
$select = $pdo->prepare("SELECT sum(total) AS total ,count(invoice_id) as inv FROM tbl_invoice");
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo  number_format($total_invoice);?><sup style="font-size: 10px"></sup></h3>
