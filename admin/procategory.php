...
$insert=$pdo->prepare("insert into product_category(category) values(:category)");
...
$update=$pdo->prepare("update product_category set category=:category where id=".$id);
...
if(isset($_POST['btndelete'])){
 ...
 $delete=$pdo->prepare("delete from product_category where id=".$_POST['btndelete']); 
...
<div class="content-wrapper">
    ...
    $select=$pdo->prepare("select * from product_category where id=".$_POST['btnedit']); 
    $select->execute();
    if($select){
...
<input type="hidden" class="form-control" value="'.$row->id.'" name="txtid"  placeholder="Enter Category" >
    ...
    <button type="submit" class="btn btn-info" name="btnupdate">Update</button>
        ...
        echo' <div class="col-md-4">
         ...
         ?>
               ...
               <tbody>
    <?php
    $select=$pdo->prepare("select * from product_category order by category desc");
    $select->execute();
